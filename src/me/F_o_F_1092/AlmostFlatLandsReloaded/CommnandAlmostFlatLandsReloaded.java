...
import me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.JSONMessage;
import me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Spigot.HelpPageListener;
import me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Spigot.JSONMessageListener;
import me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Spigot.UpdateListener;
import me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Math;
		...
		if (args.length == 0) {
			...
			if (args.length != 1) {
				...
				if (!cs.hasPermission("HelpPagePlus.Reload")) {
					...
					CommandListener.addCommand(new me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Command("/AFLR help (Page)", null, ChatColor.translateAlternateColorCodes('&', ymlFileMessage.getString("HelpText.1"))));
					CommandListener.addCommand(new me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Command("/AFLR info", null, ChatColor.translateAlternateColorCodes('&', ymlFileMessage.getString("HelpText.2"))));
					CommandListener.addCommand(new me.F_o_F_1092.AlmostFlatLandsReloaded.PluginManager.Command("/AFLR reload", "MessageMe.Reload", ChatColor.translateAlternateColorCodes('&', ymlFileMessage.getString("HelpText.3"))));
