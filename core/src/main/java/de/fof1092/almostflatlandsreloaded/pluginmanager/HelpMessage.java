...
public class HelpMessage {
	...
	public HelpMessage(String commandString, String commandColloredString, String helpMessage) {
		...
		if (VersionManager.getServerType() == VersionManager.ServerType.BUKKIT) {
			this.jsonHelpMessage = de.fof1092.almostflatlandsreloaded.pluginmanager.Spigot.JSONMessageListener.putJSONMessagesTogether(jsonMessages);
		} else if (VersionManager.getServerType() == VersionManager.ServerType.BUNGEECORD) {
